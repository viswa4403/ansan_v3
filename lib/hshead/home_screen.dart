import 'package:ansan/hshead/profile/profile_screen.dart';
import 'package:ansan/util/chat_bot/chat_bot_screen.dart';
import 'package:ansan/util/home/officials_component.dart';
...
class HsHeadHomeScreen extends StatefulWidget {
  const HsHeadHomeScreen({super.key});

  @override
  State<HsHeadHomeScreen> createState() => _HsHeadHomeScreenState();
}

class _HsHeadHomeScreenState extends State<HsHeadHomeScreen> {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        OfficialsComponent(userData: userData),
                        const SizedBox(
                          height: 24,
                        ),
