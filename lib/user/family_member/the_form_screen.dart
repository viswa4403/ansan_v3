...
class FamilyMemberQuestionnaireForm extends StatefulWidget {
  const FamilyMemberQuestionnaireForm({super.key, required this.familyMemberId, required this.familyMemberName});

  final String familyMemberId, familyMemberName;

  @override
  State<FamilyMemberQuestionnaireForm> createState() => _FamilyMemberQuestionnaireFormState();
}

class _FamilyMemberQuestionnaireFormState extends State<FamilyMemberQuestionnaireForm> {
  ...
  Future<String> _submitSurvey() async {
    ...
    try {
      ...
      await db
          .collection("userData")
          .doc(widget.familyMemberId)
          .collection("medicalHistory")
          .add(theFormData);
      await db.collection("userData").doc(widget.familyMemberId).set({
