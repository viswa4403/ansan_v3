...
class UserAllMedicalHistory extends StatefulWidget {
  const UserAllMedicalHistory({super.key, required this.userData});

  final Map<String, dynamic> userData;

  @override
  State<UserAllMedicalHistory> createState() => _UserAllMedicalHistoryState();
}

class _UserAllMedicalHistoryState extends State<UserAllMedicalHistory> {
