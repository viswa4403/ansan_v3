import 'package:ansan/admin/patients/patient_test_result.dart';
import 'package:ansan/doctor/patients/patient_test_result.dart';
import 'package:ansan/frontline_worker/patients/patient_test_result.dart';
import 'package:ansan/hshead/patients/patient_test_result.dart';
import 'package:ansan/user/test_results/patient_test_result.dart';
...
class PatientTestResults extends StatefulWidget {
  ...
  @override
  State<PatientTestResults> createState() => _PatientTestResultsState();
}

class _PatientTestResultsState extends State<PatientTestResults> {
        ...
        Navigator.of(context).push(
          CupertinoPageRoute(builder: (context) {
            switch (widget.userData["userRole"]) {
              case "A":
                return AdminPatientTestResultScreen(
                  userData: widget.userData,
                  patientData: widget.patientData,
                  reportId: _allHistoryData[index]["reportId"],
                );
              case "D":
                return DoctorPatientTestResultScreen(
                  userData: widget.userData,
                  patientData: widget.patientData,
                  reportId: _allHistoryData[index]["reportId"],
                );
              case "H":
                return HsHeadPatientTestResultScreen(
                  userData: widget.userData,
                  patientData: widget.patientData,
                  reportId: _allHistoryData[index]["reportId"],
                );
              case "F":
                return FrontlineWorkerPatientTestResultScreen(
                  userData: widget.userData,
                  patientData: widget.patientData,
                  reportId: _allHistoryData[index]["reportId"],
                );
              case "U":
                return UserPatientTestResultScreen(
                  userData: widget.userData,
                  patientData: widget.patientData,
                  reportId: _allHistoryData[index]["reportId"],
                );
