...
class AllMedicalHistory extends StatefulWidget {
  const AllMedicalHistory(
      {super.key, required this.patientData, required this.userData});

  final Map<String, dynamic> patientData, userData;

  @override
  State<AllMedicalHistory> createState() => _AllMedicalHistoryState();
}

class _AllMedicalHistoryState extends State<AllMedicalHistory> {
                        ...
                        if (_allHistoryData.isEmpty) ...[
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "No medical history found for this patient. Please add your medical history to view it here.",
                                  textAlign: TextAlign.center,
                                  style: GoogleFonts.poppins(
